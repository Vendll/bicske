    ...
    return /*#__PURE__*/ jsx_runtime_.jsx((external_prism_react_renderer_default()), {
        ...
        children: ({ className , style , tokens , getTokenProps  })=>/*#__PURE__*/ jsx_runtime_.jsx("pre", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx("code", {
                    children: tokens.map((line, index1)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(external_react_.Fragment, {
                            children: [
                                line.map((token, index)=>/*#__PURE__*/ jsx_runtime_.jsx("span", {
                                        ...getTokenProps({
                                            token
                                        })
                                    }, index)
...
const nodes = {
    ...
    th: {
        ...
        render: (props)=>/*#__PURE__*/ jsx_runtime_.jsx("th", {
                ...props
            })
    },
    fence: {
...
function Gradient({ color ="blue" , ...props }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("radialGradient", {
        ...
        ...props,
        children: gradients[color].map((stop, index)=>/*#__PURE__*/ jsx_runtime_.jsx("stop", {
                ...stop
            }, index)
        )
    });
...
;// CONCATENATED MODULE: ./src/components/LinkGrid.jsx
